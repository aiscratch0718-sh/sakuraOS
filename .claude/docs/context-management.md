...
```markdown
<!-- STATUS -->
Epic: Core feature interaction System
Feature: Melee Core feature interaction
...
- The status line displays it as a breadcrumb: `Core feature interaction System > Melee Core feature interaction > Hitboxes`
