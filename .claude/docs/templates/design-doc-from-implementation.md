...
**Persistence**:
- Saved: [What is saved to user save file]
...
- [Data files]: [Required config/feature tradeoff data]

---

## 5. Feature Tradeoff and Tuning
...
**Feature Tradeoff Concerns Identified**:
- ⚠️ [Concern 1]: [What's wrong, suggested fix]
- ⚠️ [Concern 2]: [What's wrong, suggested fix]

**Recommended Feature Tradeoff Pass**:
- Run `/tradeoff-check` on [specific aspect]
- Usability Test with focus on [specific scenario]
...
- [ ] **Feature Tradeoff pass**: Run `/tradeoff-check` on progression curve
...
**Related Skills**:
- `/tradeoff-check` — Validate formulas and progression
