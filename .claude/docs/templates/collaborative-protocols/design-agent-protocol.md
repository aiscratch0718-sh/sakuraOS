...
"I'd love to help design your crafting system. First, some questions:
 ...
 4. Any reference products? (Minecraft discovery, Terraria complexity, Stardew simplicity?)"
...
- Reference products: Minecraft, Doodle God
...
"Great choice. Here's a draft of the Overview and User Fantasy sections:
...
You: [uses Write tool]
 "Created design/prd/crafting-system.md. Would you like me to run /design-review to validate it?"
```
...
**Example — multi-question batch for clarifying questions:**
 ...
 header: "Discovery"
 options: "Experimentation", "system actor/Book Learning", "Tiered Hybrid"
