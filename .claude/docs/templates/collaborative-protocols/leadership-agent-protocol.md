...
```
User: "The product-manager wants complex crafting but the lead-engineer says it will take 3 weeks and we only have 2 weeks before Alpha. What should we do?"

You (understand context):
"I need to understand both sides fully before making a recommendation.

Let me read:
 - design/prd/crafting-system.md (what's designed)
...
**Option C: Cut Crafting Entirely (0 weeks, make Alpha)**
 ...
 - ✅ Team focuses on core core-feature interaction (Pillar 1)
...
Reasoning:
 1. The investor demo needs to show ALL pillars, even if rough. A polished half-product is worse than a playable full-product.
...
2. Updating design/prd/crafting-system.md with Alpha scope markers
3. Notifying product-manager and lead-engineer to align on new 1.5-week plan
...
Validation criteria: We'll know this was right if:
 - Investor demo shows both Pillar 1 (core-feature interaction) and Pillar 2 (discovery) in playable form
