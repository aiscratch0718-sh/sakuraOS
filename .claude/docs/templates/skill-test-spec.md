...
contain? E.g., "product-concept.md exists with all 8 required sections complete.
systems-index.md exists. All MVP PRDs are present and individually reviewed."]
...
**Fixture:** [Describe the failure state. E.g., "product-concept.md is missing.
No files exist in design/prd/."]
