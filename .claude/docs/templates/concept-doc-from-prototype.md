...
💡 **[Insight 1]**: [What we learned about product design]
- **Implication**: [How this affects future work]

💡 **[Insight 2]**: [Design learning]
- **Implication**: [Impact on PRD or other systems]
...
- [ ] [Requirement 4 — e.g., "Integrate with user-progression systems"]
...
**If No — Why Not?**:
- [Reason 1 — e.g., "Fun but doesn't fit product pillars"]
...
**How This Relates to Product Pillars** (if product pillars are defined):
...
**Overall Pillar Fit**: [Does this belong in the product?]
...
2. **[Task 2]**: [e.g., "Usability Test with 5+ people"]
...
**Inspired By** (products/mechanics this was influenced by):
- [Product 1]: [What mechanic or feeling]
- [Product 2]: [What was borrowed or adapted]

**Differs From** (how this is unique or different):
- [Difference 1]
- [Difference 2]

**Integrates With** (existing product systems):
...
2. **[Question 2]**: [What needs usability testing or iteration?]
...
| [Date] | [User] | Clarified outcomes, added usability test feedback |
