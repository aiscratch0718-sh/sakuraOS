...
- **Who**: [all users / affected users only / users who logged in during incident]
...
- [ ] Engineering Manager — Timeline and communication reviewed
- [ ] Customer Success Manager — User communication reviewed
