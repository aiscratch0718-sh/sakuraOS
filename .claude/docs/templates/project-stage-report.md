...
**Analysis Scope**: [Full project | Specific role: programmer/designer/engineering manager]
...
- **Files Found**: [N] documents in `design/`
 ...
 - Brand & content: [N] files in `design/brand/`, `design/content/`
 - Design system: [N] files in `design/design-system/`
- **Key Gaps**:
...
src/
 app/ [N] files (Next.js app router) or pages/ (Pages router)
 components/ [N] files
 lib/ [N] files
 server/ or api/ [N] files
