...
Manual trigger at the end of each sprint (typically invoked by the engineering manager
...
```
@engineering manager Generate sprint retrospective for Sprint [N]
```

The engineering manager agent should:
