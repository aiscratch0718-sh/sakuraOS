...
Read relevant design documents from `design/prd/` if the task relates to a documented feature or system.
...
- Whether this touches core/framework code vs leaf/feature code
...
|--------|-----------|-------|
| Systems affected | [List] | [Core, user flow, UI, etc.] |
