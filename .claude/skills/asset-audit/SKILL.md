---
name: asset-audit
description: "Audits product assets for compliance with naming conventions, file size budgets, format standards, and pipeline requirements. Identifies orphaned assets, missing references, and standard violations."
...
Read the design system bible or asset standards from the relevant design docs and the CLAUDE.md naming conventions.
...
- `assets/stylesheets/**/*` for stylesheets
...
- Audio: Correct sample rate, format (OGG for UI sound cues, OGG/MP3 for music), within duration limits
...
- Run `/content-audit` to cross-check asset counts against PRD-specified requirements.
