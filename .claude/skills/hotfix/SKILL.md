...
### Approvals
- [ ] Fix reviewed by lead-engineer
- [ ] Regression test passed (qa-engineer)
- [ ] Release approved (engineering manager)
...
- `subagent_type: lead-engineer` — Review the fix for correctness and side effects
- `subagent_type: qa-engineer` — Run targeted regression tests on the affected system
- `subagent_type: engineering manager` — Approve deployment timing and communication plan
...
**Approvals**: lead-engineer ✓ / qa-engineer ✓ / engineering manager ✓
