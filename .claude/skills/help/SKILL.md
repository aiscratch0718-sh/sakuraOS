...
This skill figures out exactly where you are in the web/SaaS development pipeline and
...
2. **If stage.txt is missing**, infer phase from artifacts (most-advanced match wins):
 ...
 - `design/prd/systems-index.md` exists → `systems-design`
 - `design/prd/product-concept.md` exists → `concept`
...
For repeatable steps outside production (e.g. "System PRDs"), the artifact
