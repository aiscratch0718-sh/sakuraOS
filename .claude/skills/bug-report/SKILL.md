...
## Classification
- **Category**: [User-facing behavior / UI / Audio / Visual / Performance / Crash / Network]
...
- **Product State**: [Relevant state -- inventory, task progress, etc.]
...
- **CANNOT VERIFY** — automated checks inconclusive; manual usability test required
