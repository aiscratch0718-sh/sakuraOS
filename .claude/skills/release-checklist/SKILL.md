...
- [ ] Zero S2 (Major) bugs -- or documented exceptions with engineering manager approval
...
- [ ] Performance within budgets:
 ...
 - [ ] No memory leaks over extended use sessions
...
- [ ] Customer-facing launch announcements drafted (in-app banner, email, status page)
