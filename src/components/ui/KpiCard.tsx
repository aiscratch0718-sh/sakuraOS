...
export function KpiCard({
  ...
  return (
    <div
      className={`dashboard-kpi-card relative h-[100px] overflow-hidden rounded-lg border bg-white px-3 py-1.5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-shadow hover:shadow-md ${a.borderColor}`}
    >
      ...
      <div className="mb-0.5 flex min-h-[28px] items-center justify-between gap-2">
        <div className="text-[24px] font-black leading-none tracking-normal text-slate-950">
          {value}
          {unit && (
