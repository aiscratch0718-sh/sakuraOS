...
**Context:** Solo indie dev, end of week 5. The Systems Design phase feels complete — 6 MVP PRDs written, cross-review done, framework set up. User wants to formally advance to Technical Setup.

**Starting State:**
- `production/stage.txt` — currently `systems-design`
- `design/prd/systems-index.md` — 6 MVP systems listed, all marked `Status: PRD Complete`
- `design/prd/` — 6 PRD files present
- `design/prd/prd-cross-review-2026-03-10.md` — cross-review report, verdict: CONCERNS (1 low-priority note)
- Framework configured (Next.js.6, `/setup-stack` complete)
...
> |----------|-------------|--------|
> | `design/prd/systems-index.md` | Exists, all MVP systems listed | ✅ |
> | Per-system PRDs | All MVP systems have a PRD | ✅ (6/6) |
> | `/design-review` per PRD | Each PRD reviewed | ✅ (6/6 review comments found) |
> | Cross-PRD review report | `design/prd/prd-cross-review-*.md` exists | ✅ |
> | Cross-review verdict | PASS or CONCERNS (not FAIL) | ✅ CONCERNS |
> | Framework configured | `production/stage.txt` or CLAUDE.md framework entry | ✅ Next.js.6 |
>
> ---
> **Content Scan:**
>
> Checking PRD completeness (8 required sections each)...
>
> | PRD | Missing Sections |
> |-----|-----------------|
> | auth.md | None ✅ |
> | multi-tenancy.md | None ✅ |
> | billing.md | None ✅ |
> | dashboard.md | None ✅ |
> | notifications.md | None ✅ |
> | reporting.md | None ✅ |
>
> ---
> **Cross-Review Concerns (from `prd-cross-review-2026-03-10.md`):**
>
> 1. ⚠️ LOW — Billing and reporting both define a "currency precision" constant independently with different defaults (billing: 4 decimals for internal calc, reporting: 2 decimals for display). One system should be the authority; the other should reference it. Not blocking — can resolve in ADR.
>
> ---
> **Verdict: PASS**
>
...
>
> 3. **`/architecture-review`** — Validates all ADRs for completeness, dependency ordering, and PRD traceability. Produces the TR-registry.
>
> 4. **`/create-permissions-manifest`** — Converts Accepted ADRs into a flat programmer rules sheet. This is what implementation agents will consult during coding.
>
...
> - `/setup-stack` re-run if you haven't yet fetched Next.js.6 API snapshots
>
...
>
> Run `/architecture-decision` and it will guide you through the ADR format, including the Dependencies section that links this ADR back to the two PRDs.
...
**Agent:**
> Good starting point. The ADR will document the decision, the reasoning, and the PRD requirements it addresses — so when you write code months from now, the rationale is preserved.
>
